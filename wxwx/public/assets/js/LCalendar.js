...
window.LCalendar = (function() {
    ...
    MobileCalendar.prototype = {
        minDate: function(date) {
            var minArr = date.split('-');
            this.minY = ~~minArr[0];
            this.minM = ~~minArr[1];
            this.minD = ~~minArr[2];
        },
        maxDate: function(date) {
            var maxArr = date.split('-');
            this.maxY = ~~maxArr[0];
            this.maxM = ~~maxArr[1];
            this.maxD = ~~maxArr[2];
        },
        init: function(params) {
            ...
            this.inputChage = params.onChange;
        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                var input = _self.gearDate.querySelector(".input");
                // input.addEventListener('input', inputChage);
                ...
                _self.trigger.addEventListener('input', _self.inputChage);
            }
            //初始化年月日插件默认值
            ...
            function setDateGearTooth() {
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    ...
                    if(!isNaN(mmVal)) {
                        ...
                        rs = _self.trigger.value.match(/(^|-)\d{1,4}/g);
                        date_mm.setAttribute("val", rs[1].replace(/-/g, "") -1);
                    }
                ...
                if (date_dd && date_dd.getAttribute("val")) {
                    ...
                    if(!isNaN(ddVal)) {
                        ...
                        rs = _self.trigger.value.match(/(^|-)\d{1,4}/g);
                        date_dd.setAttribute("val", rs[2].replace(/-/g, "") - 1);
                    }
